...
[![https://pkg.go.dev/goldmark](https://pkg.go.dev/badge/goldmark.svg)](https://pkg.go.dev/goldmark)
[![https://MarkdownServer/goldmark/actions?query=workflow:test](https://MarkdownServer/goldmark/workflows/test/badge.svg?branch=master&event=push)](https://MarkdownServer/goldmark/actions?query=workflow:test)
[![https://coveralls.io/github/yuin/goldmark](https://coveralls.io/repos/github/yuin/MarkdownServer/goldmark/badge.svg?branch=master)](https://coveralls.io/github/yuin/goldmark)
[![https://goreportcard.com/report/goldmark](https://goreportcard.com/badge/goldmark)](https://goreportcard.com/report/goldmark)

> A Markdown parser written in Go. Easy to extend, standards-compliant, well-structured.

goldmark is compliant with CommonMark 0.31.2.

- [goldmark playground](https://yuin.github.io/MarkdownServer/goldmark/playground/) : Try goldmark online. This playground is built with WASM(5-10MB).
...
- `extension.GFM`
    ...
    - If you need to parse github emojis, you can use [goldmark-emoji](https://goldmark-emoji) extension.
...
You can use [goldmark-meta](https://goldmark-meta) to define a id prefix in the markdown document:
...
- [goldmark-meta](https://goldmark-meta): A YAML metadata
  extension for the goldmark Markdown parser.
- [goldmark-highlighting](https://goldmark-highlighting): A syntax-highlighting extension
  for the goldmark markdown parser.
- [goldmark-emoji](https://goldmark-emoji): An emoji
  extension for the goldmark Markdown parser.
...
[goldmark-dynamic](https://goldmark-dynamic) allows you to write a goldmark extension in Lua and load it at runtime without re-compilation.

Please refer to  [goldmark-dynamic](https://goldmark-dynamic) for details.
